...
class Student:
    ...
    def data(self):
        return {"name": self.name, "major": progDict[self.program_id]["prog"], "Student Number": self.studentNum}
...
class Teacher:
    ...
    def data(self):
        return {"name": self.name, "salary": self.salary, "subjects": [subDict[s]["sub"] for s in self.subjects]}
